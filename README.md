...
**The reading bar holds only what is used mid-song:** Back, the title, Hide chords, a gear and Edit.
...
**Chords on and off is one button in the reading view's top bar,** labelled with what a tap
does — Hide chords, Show chords. It was a bare "Chords" with a pressed state, and was not read
as a switch. Off, the song is words only:
